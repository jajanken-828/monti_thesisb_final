...
<template>
    <div class="relative min-h-screen flex flex-col bg-cover bg-center bg-no-repeat"
        ...
        <!-- HEADER – sticky with backdrop blur (matching new Welcome.vue) -->
                    ...
                    <div class="px-8 pt-10 pb-10 sm:px-12 sm:pt-12 sm:pb-12">
                        ...
                        <div class="text-center mb-10">
                            ...
                            <p class="mt-3 text-slate-200 text-base sm:text-lg max-w-md mx-auto">
                                Welcome back! Please enter your registered B2B credentials to access your dashboard.
                            </p>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <TextInput id="password" :type="showPassword ? 'text' : 'password'"
                                        class="mt-1 pr-12 block w-full py-3 px-4 bg-white/15 border border-white/30 text-white placeholder:text-slate-300 rounded-xl focus:border-blue-400 focus:ring-blue-400/40"
