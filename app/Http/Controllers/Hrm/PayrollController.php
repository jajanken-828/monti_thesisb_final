...
class PayrollController extends Controller
{
    ...
    public function generate(Request $request)
    {
        ...
        NotifiesExecutive::push('payroll', count($payrollRecords) . ' payroll records pending approval', 'A new payroll batch was generated and awaits executive sign-off.', 'ceo.approvals');
