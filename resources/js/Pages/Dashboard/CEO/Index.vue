        ...
        <div class="min-h-screen bg-gradient-to-b from-slate-50 via-white to-blue-50/40 dark:from-zinc-950 dark:via-zinc-950 dark:to-indigo-950/30 font-sans">
            <div class="p-4 sm:p-6 max-w-7xl mx-auto space-y-6 pb-16">
                ...
                <div class="animate-fade-up relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-700 via-indigo-700 to-violet-800 p-6 sm:p-8 text-white shadow-xl shadow-indigo-500/20">
                    ...
                    <div class="relative mt-6 flex flex-col sm:flex-row gap-3">
                        <div class="flex flex-wrap items-center gap-2">
                            <button class="flex items-center gap-2 rounded-2xl bg-white px-4 py-2.5 text-xs font-black uppercase tracking-wide text-indigo-700 shadow-lg transition-all duration-200 hover:scale-105 active:scale-95">
                                <Filter class="w-4 h-4" /> Filters
                            </button>
                            <button class="flex items-center gap-2 rounded-2xl bg-white/15 px-4 py-2.5 text-xs font-black uppercase tracking-wide text-white backdrop-blur transition-all duration-200 hover:bg-white/25 active:scale-95">
                                <Download class="w-4 h-4" /> Exports
                            </button>
                            <button class="flex items-center gap-1 rounded-2xl bg-white/15 px-4 py-2.5 text-xs font-black uppercase tracking-wide text-white backdrop-blur transition-all duration-200 hover:bg-white/25 active:scale-95">
                                Weekly
                    ...
                    <div class="xl:col-span-4 flex flex-col gap-4">
                        ...
                        <div class="animate-fade-up group relative bg-white/80 dark:bg-zinc-900/80 backdrop-blur rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/15 hover:-translate-y-1.5 hover:border-indigo-200 dark:hover:border-indigo-800 transition-all duration-300 p-6 sm:p-7 overflow-hidden" style="animation-delay: 80ms">
                            ...
                            <div class="relative flex justify-between items-center mb-8">
                                <div>
                                    <h2 class="text-xl font-black tracking-tight text-gray-900 dark:text-white">Summary</h2>
                                    <p class="text-xs font-bold uppercase tracking-wide text-gray-400">Track your performance.</p>
                                </div>
                                <span class="flex h-8 w-8 items-center justify-center rounded-xl bg-indigo-50 dark:bg-indigo-900/20 text-indigo-500">
                            ...
                            <div class="relative flex gap-4 mb-10">
                                <div class="flex-1">
                                    <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 font-bold uppercase mb-1">
                                        <span class="flex h-6 w-6 items-center justify-center rounded-lg bg-blue-50 dark:bg-blue-900/20">
                                            <ArrowDownRight class="w-3 h-3 text-blue-500" />
                                        </span>
                                        Total income
                                    </div>
                                    <div class="text-2xl font-black tracking-tight text-gray-900 dark:text-white">₱{{ formattedTotalRevenue }}</div>
                                </div>
                                ...
                                <div class="flex-1 pl-2">
                                    ...
                                    <div class="text-2xl font-black tracking-tight text-gray-900 dark:text-white">{{ formattedTotalOrders }}</div>
                                </div>
                            </div>
                            ...
                            <div class="relative flex justify-between mt-3 text-[10px] font-bold uppercase text-gray-400">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="animate-fade-up group relative bg-white/80 dark:bg-zinc-900/80 backdrop-blur rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/15 hover:-translate-y-1.5 hover:border-indigo-200 dark:hover:border-indigo-800 transition-all duration-300 p-6 overflow-hidden" style="animation-delay: 140ms">
                                <div class="pointer-events-none absolute -top-16 -right-16 h-40 w-40 rounded-full bg-gradient-to-br from-indigo-400/20 to-fuchsia-400/20 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                <div class="relative flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 font-bold uppercase mb-4">
                                    <span class="flex h-6 w-6 items-center justify-center rounded-lg bg-blue-50 dark:bg-blue-900/20"><Clock class="w-3 h-3 text-blue-500" /></span> Active Employees
                                </div>
                                <div class="relative flex items-center gap-1 text-sm font-black text-gray-900 dark:text-white mb-1">
                                    <span class="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" /> Current
                                </div>
                                <div class="relative text-2xl font-black text-gray-900 dark:text-white">{{ stats.activeEmployees }}</div>
                            </div>
                            <div class="animate-fade-up group relative bg-white/80 dark:bg-zinc-900/80 backdrop-blur rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/15 hover:-translate-y-1.5 hover:border-indigo-200 dark:hover:border-indigo-800 transition-all duration-300 p-6 overflow-hidden" style="animation-delay: 200ms">
                                ...
                                <div class="relative flex items-center gap-1 text-sm font-black text-indigo-600 dark:text-indigo-300 mb-1">
                                    <ArrowUpRight class="w-4 h-4" /> Inquiry
                                </div>
                                <div class="relative text-2xl font-black text-gray-900 dark:text-white">{{ stats.pendingLeads }}</div>
                            </div>
                        </div>
                        ...
                        <Transition name="modal">
                            <div v-if="showBanner" class="animate-fade-up group relative bg-white/80 dark:bg-zinc-900/80 backdrop-blur rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/15 p-6 flex justify-between items-center overflow-hidden transition-all duration-300" style="animation-delay: 260ms">
                                <div class="pointer-events-none absolute -top-16 -right-16 h-40 w-40 rounded-full bg-gradient-to-br from-indigo-400/20 to-fuchsia-400/20 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                <h3 class="relative font-black text-base text-gray-900 dark:text-white leading-tight max-w-[200px] tracking-tight">
                    ...
                    <div class="xl:col-span-8 flex flex-col gap-4">
                        ...
                        <div class="animate-fade-up" style="animation-delay: 120ms">
                            <div class="flex justify-between items-center mb-4 px-2">
                                <div>
                                    <h2 class="text-xl font-black tracking-tight text-gray-900 dark:text-white">Activity</h2>
                                    <p class="text-xs font-bold uppercase tracking-wide text-gray-400">Track your activity.</p>
                                </div>
                                <div class="flex gap-2">
                                    <button class="w-10 h-10 rounded-2xl bg-white/80 dark:bg-zinc-900/80 backdrop-blur flex items-center justify-center shadow-sm border border-gray-100 dark:border-zinc-800 hover:-translate-y-0.5 hover:shadow-lg transition-all">
                                        <Settings2 class="w-4 h-4 text-gray-600 dark:text-gray-300" />
                                    </button>
                                    <button class="w-10 h-10 rounded-2xl bg-white/80 dark:bg-zinc-900/80 backdrop-blur flex items-center justify-center shadow-sm border border-gray-100 dark:border-zinc-800 hover:-translate-y-0.5 hover:shadow-lg transition-all">
                                        <ArrowUpRightSquare class="w-4 h-4 text-gray-600 dark:text-gray-300" />
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="group relative bg-white/80 dark:bg-zinc-900/80 backdrop-blur rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/15 hover:-translate-y-1.5 hover:border-indigo-200 dark:hover:border-indigo-800 transition-all duration-300 p-6 flex flex-col overflow-hidden">
                                    ...
                                    <div class="flex items-center gap-3 mb-6 relative z-10">
                                        ...
                                        <span class="font-black text-sm text-gray-900 dark:text-white">Receipts</span>
                                        <span class="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse ml-auto" />
                                    </div>
                                    <div class="relative z-10">
                                        <div class="text-indigo-600 dark:text-indigo-300 text-sm font-black flex items-center gap-1 mb-1">
                                            <ArrowUpRight class="w-4 h-4" /> {{ activityStats.receipts.trend }}
                                        </div>
                                        <div class="text-3xl font-black tracking-tight text-gray-900 dark:text-white">₱{{ activityStats.receipts.value }}</div>
                                    </div>
                                ...
                                <div class="group relative bg-white/80 dark:bg-zinc-900/80 backdrop-blur rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/15 hover:-translate-y-1.5 hover:border-indigo-200 dark:hover:border-indigo-800 transition-all duration-300 p-6 flex flex-col overflow-hidden">
                                    ...
                                    <div class="flex items-center gap-3 mb-6 relative z-10">
                                        ...
                                        <span class="font-black text-sm text-gray-900 dark:text-white">Contributions</span>
                                        <span class="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse ml-auto" />
                                    </div>
                                    <div class="relative z-10">
                                        <div class="text-indigo-600 dark:text-indigo-300 text-sm font-black flex items-center gap-1 mb-1">
                                        ...
                                        <div class="text-3xl font-black tracking-tight text-gray-900 dark:text-white">₱{{ activityStats.contributions.value }}</div>
                                    </div>
                                    <div class="absolute bottom-0 left-0 w-full h-24 opacity-80 group-hover:opacity-100 transition duration-500">
                                        <svg viewBox="0 0 200 60" preserveAspectRatio="none" class="w-full h-full">
                        ...
                        <div class="animate-fade-up group relative bg-white/80 dark:bg-zinc-900/80 backdrop-blur rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/15 transition-all duration-300 p-6 sm:p-7 flex-1 overflow-hidden" style="animation-delay: 180ms">
                            ...
                            <div class="relative flex justify-between items-center mb-6">
                                <div>
                                    <h2 class="text-xl font-black tracking-tight text-gray-900 dark:text-white">Transactions history</h2>
                                    <p class="text-xs font-bold uppercase tracking-wide text-gray-400">Track your history.</p>
                                </div>
                                <button class="w-10 h-10 rounded-2xl bg-gray-100 dark:bg-zinc-800 flex items-center justify-center hover:bg-indigo-600 hover:text-white text-gray-500 dark:text-gray-300 transition-all duration-300">
                            ...
                            <div class="relative overflow-x-auto">
                                <table class="w-full text-left border-collapse">
                                    <thead>
                                        <tr class="text-gray-400 dark:text-gray-500 text-[10px] font-black uppercase tracking-widest border-b border-gray-100 dark:border-zinc-800">
                                        ...
                                        <tr v-for="tx in transactions" :key="tx.id" class="border-b border-gray-50 dark:border-zinc-800/60 hover:bg-indigo-50/50 dark:hover:bg-indigo-950/30 transition-colors">
                                            <td class="py-4 px-2">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div class="font-black text-gray-900 dark:text-white tracking-tight">{{ tx.name }}</div>
                                                        <div class="text-xs text-gray-500 dark:text-gray-400 font-medium">{{ tx.role }}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="py-4 px-2 font-bold text-gray-900 dark:text-gray-200">{{ tx.id }}</td>
                                            <td class="py-4 px-2">
                                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase ring-1"
                                                    :class="tx.status === 'Completed' || tx.status === 'Approved' ? 'bg-emerald-100 text-emerald-700 ring-emerald-200 dark:bg-emerald-500/15 dark:text-emerald-300 dark:ring-emerald-500/30' : 'bg-blue-100 text-blue-700 ring-blue-200 dark:bg-blue-500/15 dark:text-blue-300 dark:ring-blue-500/30'">
                                                    <span class="w-1.5 h-1.5 rounded-full bg-current animate-pulse"></span>
                                                    {{ tx.status }}
                                                </span>
                                            </td>
                                            <td class="py-4 px-2 font-bold text-gray-900 dark:text-gray-200">{{ tx.date }}</td>
                                            <td class="py-4 px-2 text-right font-black" :class="tx.isNegative ? 'text-red-500' : 'text-gray-900 dark:text-white'">
                                                {{ tx.amount }}
                                            </td>
                                        </tr>
                                        <tr v-if="transactions.length === 0">
                                            <td colspan="5" class="py-8 text-center">
                                                <div class="flex flex-col items-center gap-2 text-gray-400">
                                                    <span class="flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-50 dark:bg-indigo-900/20 animate-bounce-soft"><Wallet class="h-5 w-5 text-indigo-400" /></span>
                ...
                <div class="pt-2 animate-fade-up" style="animation-delay: 240ms">
                    <h2 class="text-xl font-black tracking-tight text-gray-900 dark:text-white mb-4 px-2">Department Overview</h2>
                    <TransitionGroup name="card" tag="div" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div v-for="(mod, idx) in modules" :key="idx"
                            ...
                            <div class="relative flex items-center gap-3 mb-5">
                                ...
                                <h3 class="font-black tracking-tight text-gray-900 dark:text-white group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition-colors">{{ mod.title }}</h3>
                            </div>
                            <div class="relative space-y-3">
                                <div v-for="(val, key) in mod.stats" :key="key" class="flex justify-between items-center text-sm">
                                    ...
                                    <span class="font-black text-gray-900 dark:text-white">{{ val }}</span>
                                </div>
                            </div>
                        </div>
                    </TransitionGroup>
